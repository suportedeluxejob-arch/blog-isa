...
import { ChevronLeft, Star, ExternalLink, CheckCircle2, XCircle, HelpCircle, BarChart2, Camera, ShieldCheck, Award } from "lucide-react";
                    ...
                    __html: JSON.stringify(
                        isSalesArticle && post.productName
                            ? {
                                ...
                                "mainEntityOfPage": {
                                    "@type": "WebPage",
                                    "@id": post.canonicalUrl || `https://www.achadosvipdaisa.com.br/achados/${post.slug}`
                                },
                                "offers": {
                                    "@type": "Offer",
                                    "url": post.affiliateLink || `https://www.achadosvipdaisa.com.br/achados/${post.slug}`,
                                    "priceCurrency": "BRL",
